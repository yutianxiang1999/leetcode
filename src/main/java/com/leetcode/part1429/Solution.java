...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(firstUnique.showFirstUnique()); // 返回 2
        firstUnique.add(2); // 此时队列为 [2,3,5,5,2]
        System.out.println(firstUnique.showFirstUnique()); // 返回 3
        firstUnique.add(3); // 此时队列为 [2,3,5,5,2,3]
        System.out.println(firstUnique.showFirstUnique()); // 返回 -1
    }
